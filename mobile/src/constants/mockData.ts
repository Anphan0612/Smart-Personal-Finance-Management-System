...
export const MOCK_AI_MESSAGES = [
  {
    ...
    role: 'assistant',
    content:
      'Chào An! Tôi là Trợ lý Tài chính Atelier. Hôm nay bạn đã chi tiêu $45.50 cho Ăn uống. Bạn vẫn còn $179.50 trong ngân sách thực phẩm tháng này. Bạn có muốn xem chi tiết biểu đồ không?',
  ...
  },
  {
    ...
    role: 'assistant',
    content:
      'Tháng này bạn đang quản lý khá tốt! Thu nhập đạt $5,200 và chi tiêu mới chỉ chiếm 29% tổng ngân sách. Đặc biệt, chi phí đi lại (Transport) đang thấp hơn 40% so với tháng trước.',
    timestamp: new Date().toISOString(),
  },
];
