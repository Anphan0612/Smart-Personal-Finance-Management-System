  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-center justify-between mb-4">
        ...
        <View className={`px-2.5 py-1 rounded-full ${isOverBudget ? 'bg-error/10' : 'bg-primary/10'}`}>
          <AtelierTypography variant="label" className={`text-[10px] font-bold ${isOverBudget ? 'text-error' : 'text-primary'}`}>
      ...
      <View className="mb-4">
        <View className="flex-row items-baseline gap-1">
          ...
          <AtelierTypography variant="body" className="text-[14px] text-surface-on-variant opacity-60">
            {currency} / {budgetLimit.toLocaleString()} {currency}
          </AtelierTypography>
        </View>
        <AtelierTypography variant="label" className="text-[12px] text-surface-on-variant mt-1 opacity-70">
      ...
      <View className="flex-row items-center gap-1.5 mt-4 pt-4 border-t border-outline-variant/10">
        ...
        <AtelierTypography variant="label" className="text-[11px] text-surface-on-variant opacity-60">
