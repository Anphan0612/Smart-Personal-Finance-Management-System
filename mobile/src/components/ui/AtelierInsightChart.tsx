  ...
  if (!data || data.length === 0) {
    return (
      ...
      >
        ...
        <AtelierTypography variant="label" className="text-[11px] text-surface-on-variant text-center px-6">
          ...
          centerLabelComponent={() => {
            return (
              <View className="justify-center items-center">
                <AtelierTypography variant="label" className="text-[10px] text-surface-on-variant">Tổng chi</AtelierTypography>
        ...
        <View className="flex-row flex-wrap justify-center mt-6 gap-3">
          {pieData.map((item, index) => (
            <View key={index} className="flex-row items-center">
              ...
              <AtelierTypography variant="label" className="text-[11px] font-medium text-surface-on">
                {item.label}
              </AtelierTypography>
            </View>
          ))}
