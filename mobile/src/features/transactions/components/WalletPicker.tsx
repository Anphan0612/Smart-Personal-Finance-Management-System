...
import { CreditCard, Banknote, Smartphone, LineChart, ChevronRight } from 'lucide-react-native';
    ...
    <View className="gap-4">
      ...
      >
        ...
        <View className="flex-1">
          ...
          >
            {selectedWallet
              ? `Balance: ${new Intl.NumberFormat('vi-VN').format(selectedWallet.balance)} đ`
