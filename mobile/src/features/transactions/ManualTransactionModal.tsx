...
import { X, FileText, Check, Wallet, ArrowRight, Info } from 'lucide-react-native';
                ...
                <View className="flex-1">
                  ...
                  >
                    ...
                    >
                      <AtelierTypography
                        variant="label"
                        className="text-neutral-400 mb-4 tracking-[2px]"
                      >
                        SỐ TIỀN
                      </AtelierTypography>
                    ...
                    <View className="px-8 pt-2 pb-2 gap-y-8">
                      ...
                      <View className="gap-y-3">
                        <AtelierTypography
                          variant="label"
                          className="text-neutral-400 ml-1 tracking-[2px]"
                        >
                          TÀI KHOẢN / VÍ
                        </AtelierTypography>
                        <WalletPicker
                        ...
                        {isInsufficientBalance && (
                          ...
                          >
                            ...
                            <AtelierTypography variant="caption" className="text-error flex-1">
                              Số dư không đủ (
                              {new Intl.NumberFormat('vi-VN').format(selectedWallet?.balance || 0)}{' '}
                              đ)
                            </AtelierTypography>
                          </MotiView>
                        )}
                  ...
                  <View className="absolute bottom-0 left-0 right-0 px-8 pb-10 pt-4 bg-white/90 border-t border-neutral-50">
                    <View className="flex-row gap-x-4">
                      ...
                      >
                        <AtelierTypography
                          variant="label"
                          className="text-neutral-900 tracking-[1px]"
                        >
                          HỦY
                        </AtelierTypography>
                      </TouchableOpacity>
