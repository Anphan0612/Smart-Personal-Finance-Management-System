...
// --- Component ---
export const ChangePasswordSheet = forwardRef<ChangePasswordSheetRef>(
  (_, ref) => {
          ...
          {isSuccess ? (
            ...
            >
              ...
              <View className="items-center gap-2">
                <AtelierTypography 
                  style={{ fontFamily: 'Manrope_800ExtraBold', fontSize: 28, color: Colors.neutral[900] }}
                >
                  Hoàn tất!
                </AtelierTypography>
                <AtelierTypography variant="body" className="text-neutral-400 text-center px-8 leading-6">
            ...
            <>
              ...
              <View className="gap-5">
                ...
                <AtelierInput
                  ...
                  error={
                    !passwordsMatch ? "Mật khẩu xác nhận không khớp" : undefined
                  }
                />
              </View>
            </>
