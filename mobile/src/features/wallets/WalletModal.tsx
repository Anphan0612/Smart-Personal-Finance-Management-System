          ...
          <View style={styles.container}>
            ...
            >
              ...
              <View className="flex-1">
                ...
                >
                  ...
                  <View className="px-8 gap-y-8">
                    ...
                    <View className="space-y-3">
                      <AtelierTypography
                        variant="label"
                        className="text-neutral-400 font-bold uppercase tracking-widest ml-1"
                      >
                        TÊN TÀI KHOẢN
                      </AtelierTypography>
                    ...
                    <View className="space-y-3">
                      ...
                      <View className="flex-row items-center bg-white rounded-[28px] px-6 h-18 border border-neutral-100 shadow-atelier-low">
                        ...
                        <TextInput
                          ...
                          placeholderTextColor={Colors.neutral[300]}
                        />
                        <AtelierTypography variant="h3" className="text-neutral-300 ml-2">
                          đ
                        </AtelierTypography>
                      </View>
                    </View>
                        ...
                        {WALLET_TYPES.map((item) => {
                          ...
                          return (
                            ...
                            >
                              <Icon
                                size={18}
                                color={isSelected ? 'white' : Colors.neutral[400]}
                                className="mr-2"
                              />
                              <AtelierTypography
                                variant="label"
                      ...
                      {selectedType === 'BANK' && (
                        ...
                        >
                          <View className="p-5 bg-blue-50/50 rounded-[28px] border border-blue-100 flex-row items-center">
                            ...
                            <AtelierTypography
                              variant="caption"
                              className="text-primary flex-1 leading-4"
                            >
                ...
                {/* Footer */}
                <View className="absolute bottom-0 left-0 right-0 px-8 pb-12 pt-6 border-t border-neutral-50 bg-white">
                  <TouchableOpacity
                    onPress={handleSave}
